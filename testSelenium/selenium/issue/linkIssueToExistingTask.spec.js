...
describe('LinkIssueToExistingTask', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('LinkIssueToExistingTask', async function() {
    ...
    await driver.findElement(By.css(".container:nth-child(5)")).click()
    await driver.findElement(By.linkText("Nouvelle tâche")).click()
    await driver.findElement(By.id("idInput")).click()
    ...
    await driver.findElement(By.id("taskList")).click()
    {
      const dropdown = await driver.findElement(By.id("taskList"))
      await dropdown.findElement(By.xpath("//option[. = 'id']")).click()
    }
    await driver.findElement(By.css(".media:nth-child(3) option:nth-child(2)")).click()
    await driver.findElement(By.css(".media:nth-child(3) > form > .btn-success")).click()
    await driver.findElement(By.css(".media:nth-child(5) #taskList")).click()
    {
      const dropdown = await driver.findElement(By.css(".media:nth-child(5) #taskList"))
      await dropdown.findElement(By.xpath("//option[. = 'id']")).click()
    }
    await driver.findElement(By.css(".media:nth-child(5) option:nth-child(2)")).click()
    await driver.findElement(By.css(".media:nth-child(5) > form > .btn-success")).click()
    await driver.findElement(By.css(".media:nth-child(5) #taskList")).click()
    {
      const dropdown = await driver.findElement(By.css(".media:nth-child(5) #taskList"))
      await dropdown.findElement(By.xpath("//option[. = 'id1']")).click()
    }
    await driver.findElement(By.css(".media:nth-child(5) option:nth-child(3)")).click()
    await driver.findElement(By.css(".media:nth-child(5) > form > .btn-success")).click()
    await driver.findElement(By.linkText("Tâches")).click()
