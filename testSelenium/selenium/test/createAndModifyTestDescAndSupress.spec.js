...
describe('CreateAndModifyTestDescAndSupress', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('CreateAndModifyTestDescAndSupress', async function() {
    ...
    await driver.findElement(By.id("description")).click()
    await driver.findElement(By.id("description")).sendKeys("Etant donné test , Lorsque test , Alors testModified")
    await driver.findElement(By.css(".btn-primary")).click()
