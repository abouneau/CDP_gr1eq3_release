...
import java.util.*;
public class CreateModifyAndSupressMultipleTestTest {
  ...
  @Test
  public void createModifyAndSupressMultipleTest() {
    ...
    driver.findElement(By.id("description")).click();
    driver.findElement(By.id("description")).sendKeys("Etant donné ... , Lorsque test2 , Alors ...");
    driver.findElement(By.cssSelector(".btn-primary")).click();
    driver.findElement(By.linkText("Nouveau test")).click();
    driver.findElement(By.id("name")).click();
    driver.findElement(By.id("name")).sendKeys("test3");
    driver.findElement(By.id("description")).click();
    driver.findElement(By.id("description")).sendKeys("Etant donné test3 , Lorsque ... , Alors ...");
    driver.findElement(By.cssSelector(".btn-primary")).click();
    driver.findElement(By.linkText("Nouveau test")).click();
    driver.findElement(By.id("name")).click();
    driver.findElement(By.id("name")).sendKeys("test4");
    driver.findElement(By.id("description")).click();
    driver.findElement(By.id("description")).sendKeys("Etant donné ... , Lorsque ... , Alors test4");
    driver.findElement(By.cssSelector(".btn-primary")).click();
    driver.findElement(By.linkText("Nouveau test")).click();
    driver.findElement(By.id("name")).click();
    ...
    driver.findElement(By.id("name")).sendKeys("test5");
    driver.findElement(By.cssSelector(".btn-primary")).click();
    driver.findElement(By.cssSelector(".media:nth-child(6) > .btn")).click();
    driver.findElement(By.id("description")).click();
    driver.findElement(By.id("description")).sendKeys("Etant donné ... , Lorsque test2 , Alors test2");
    driver.findElement(By.cssSelector(".btn-primary")).click();
    driver.findElement(By.cssSelector(".media:nth-child(9) > .btn")).click();
    driver.findElement(By.id("description")).click();
    driver.findElement(By.id("description")).sendKeys("Etant donné ... , Lorsque ... , Alors test5");
    driver.findElement(By.cssSelector(".btn-primary")).click();
