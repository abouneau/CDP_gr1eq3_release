...
import java.util.*;
public class CreateAndModifyTestDescAndSupressTest {
  ...
  @Test
  public void createAndModifyTestDescAndSupress() {
    ...
    driver.findElement(By.id("description")).click();
    driver.findElement(By.id("description")).sendKeys("Etant donné test , Lorsque test , Alors testModified");
    driver.findElement(By.cssSelector(".btn-primary")).click();
